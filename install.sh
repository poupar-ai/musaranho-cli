...
main() (
    ...
    package=musaranho-0.1.4-x86_64-unknown-linux-gnu
    ...
    [[ "$("$temporary/$package/musaranho" --version)" == 'musaranho 0.1.4' ]] || { echo 'Executável incompatível ou versão inesperada.' >&2; exit 1; }
